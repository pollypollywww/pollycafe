                ...
                <table class="table table-rwd text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-th="訂單狀態">${order.PaymentStatus === "待付款" ? `${order.PaymentStatus} <p class="mb-0"><a href="#" class="toThisLink text-center" data-toggle="modal" data-target="#payModal${order.Id}">我已付款</a></p>` : order.PaymentStatus}</td>
