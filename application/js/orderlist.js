                ...
                <table class="table table-rwd text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="bg-warning" data-th="訂單狀態">${order.PaymentStatus === "待付款" ? `${order.PaymentStatus} <p class="text-center bg-danger"><a href="#" class="toThisLink" data-toggle="modal" data-target="#payModal${order.Id}">我已付款</a></p>` : order.PaymentStatus}</td>
